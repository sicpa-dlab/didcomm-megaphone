package com.dif.didcomm.megaphone.diddoc
...
class DIDDocResolver : DIDDocResolver {
    private val didDocResolver = DIDDocResolverInMemory(
        listOf(
            ...
            DIDDoc(
                ...
                authentications = listOf(
                    "did:example:doctor#key-1",
                    "did:example:doctor#key-2",
                    "did:example:doctor#key-3"
                ),
                keyAgreements = listOf(
                    "did:example:doctor#key-x25519-1",
                    "did:example:doctor#key-p256-1",
                    "did:example:doctor#key-p521-1",
                ),
                didCommServices = listOf(),
                verificationMethods = listOf(
                    VerificationMethod(
                        id = "did:example:doctor#key-x25519-1",
                        controller = "did:example:doctor#key-x25519-1",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                    ...
                    VerificationMethod(
                        id = "did:example:doctor#key-p256-1",
                        controller = "did:example:doctor#key-p256-1",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                    ...
                    VerificationMethod(
                        id = "did:example:doctor#key-p521-1",
                        controller = "did:example:doctor#key-p521-1",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                    ...
                    VerificationMethod(
                        id = "did:example:doctor#key-1",
                        controller = "did:example:doctor#key-1",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                    ...
                    VerificationMethod(
                        id = "did:example:doctor#key-2",
                        controller = "did:example:doctor#key-2",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                    ...
                    VerificationMethod(
                        id = "did:example:doctor#key-3",
                        type = VerificationMethodType.JSON_WEB_KEY_2020,
                        controller = "did:example:doctor#key-3",
                        verificationMaterial = VerificationMaterial(
                            VerificationMaterialFormat.JWK,
                            """
                                {
